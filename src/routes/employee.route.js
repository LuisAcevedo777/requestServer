...
const employeeUpdateValidator = require('../validators/employeeUpdate.validator')
...
employeeRouter.put("/api/employee/:id",employeeUpdateValidator,authMiddleware, verificarRol(['admin']),updateEmployeeController);
